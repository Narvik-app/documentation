...
- Présences des membres du club
  - Affichage des [contrôles configurés par le club](./controles) marqués comme visibles, avec une couleur (orange/rouge) selon les délais d'avertissement et d'alerte définis.
