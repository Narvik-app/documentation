...
- front :
  ...
  - `NUXT_OAUTH_CLIENT_ID` / `NUXT_OAUTH_CLIENT_SECRET` : Identifiants du client OAuth principal, créés côté backend par `bin/console install:oauth` (voir [Post-installation](./03.post-installation)).
